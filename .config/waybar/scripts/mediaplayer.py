...
player_icons = {"spotify": " ", "firefox": " ", "chromium": " ", "generic": " "}
...
def on_metadata(player, metadata, manager):
    ...
    if (
        ...
        player_name = (
            ...
            if player.props.player_name in player_icons
            else "generic"
        )
        track_info = "{artist} {player_icon} {title}".format(
            artist=player.get_artist(),
            player_icon=player_icons[player_name],
    ...
    write_output(icon + track_info, player)
