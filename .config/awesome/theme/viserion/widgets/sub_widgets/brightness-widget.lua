...
local function worker(user_args)
    ...
    function brightness_widget:set(value)
        current_level = value
        spawn.easy_async_with_shell(string.format(set_brightness_cmd, value), function()
    ...
    function brightness_widget:inc()
        spawn.easy_async_with_shell(inc_brightness_cmd, function()
            spawn.easy_async_with_shell(get_brightness_cmd, function(out)
                update_widget(brightness_widget.widget, out)
            end)
        end)
    ...
    function brightness_widget:dec()
        spawn.easy_async_with_shell(dec_brightness_cmd, function()
            spawn.easy_async_with_shell(get_brightness_cmd, function(out)
                update_widget(brightness_widget.widget, out)
            end)
        end)
